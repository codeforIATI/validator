...
module.exports = {
  ...
  entry: {
    ...
    main_css: [
      ...
      path.join(__dirname, 'assets', 'css', 'pygments.css'),
      path.join(__dirname, 'assets', 'css', 'style.css'),
    ],
  },
  output: {
    path: path.join(__dirname, 'iati_validator', 'static', 'build'),
  ...
  plugins: [
    ...
    new ManifestRevisionPlugin(path.join(__dirname, 'iati_validator', 'webpack', 'manifest.json'), {
      rootAssetPath,
      ignorePaths: ['/js', '/css'],
    }),
  ]
